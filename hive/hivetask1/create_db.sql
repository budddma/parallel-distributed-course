...
DROP TABLE IF EXISTS not_partitioned_logs;
CREATE EXTERNAL TABLE not_partitioned_logs (
        ip                      STRING,
        query_time              BIGINT,
...
SELECT * FROM not_partitioned_logs LIMIT 10;
...
SELECT ip, http_query_from_ip, page_size, http_status_code, client_app_info, query_time FROM not_partitioned_logs;
